...
public class HomePageController {
    ...
    // added the login endpoint, which allows users to log in by
    // calling the login.html template when the /login route is hit
    @GetMapping("/login")
    ...
    // added logout endpoint. When the logout route is hit, here
    // we check whether the sesion exists. if it does, we'll invalidate
    // the session, subsequently logging out the user then redirect
    // the user back to the login route
    ...
    // added homepage endpoint, this will show users the homepage
    @GetMapping("/")
    ...
    //added dashboard endpoint for dashboard route
...
// added single post endpoint for singlepost route
...
// added edit post endpoint for editpost route
...
// this method helps set up the user dashboard
