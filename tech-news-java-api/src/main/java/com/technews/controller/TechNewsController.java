...
public class TechNewsController {
    ...
    //added the post endpoint, it will processing for the /users/login route
    ...
    // added method that will be the post AddUser endpoint
    //This route allows users to create a new profile on Just Tech News
    @PostMapping("/users")
    ...
    //creating the GET endpoint for the dashboard
    @PostMapping("/posts")
    ...
    //route for getting updated post
    ...
    // this method will allow users to comment on their own or
    // other's posts
    ...
    // this method allows to upvote posts
